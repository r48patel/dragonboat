...
var bio_info_map = {}
fs.readdirSync(path.join(__dirname , 'views','templates')).forEach(file => {
...
function get_bio_info(name){
    ...
    var bio_file = fs.readFileSync(path.join(__dirname , 'views','templates', file_name)).toString().split('\n');
